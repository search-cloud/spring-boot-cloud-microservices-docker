package io.vincent.common.exception;

import io.vincent.common.vo.ClientMessage;
 ...
 * @author Asion
 */
public abstract class BizException extends CommonException {
	 ...
	 */
	public BizException(String code, String message, Object... values) {
	 ...
	 * @param map     动态替换的内容
	 */
	public BizException(String code, String message, Map<?, ?> map) {
		ClientMessage clientMessage = new ClientMessage();
		clientMessage.setCode(code);
	 ...
	 */
	public BizException(List<ClientMessage> errorList) {
	 ...
	 * @param <T>          业务异常的子类型
	 */
	public <T extends BizException> void addErrorToList(T bizException) {
