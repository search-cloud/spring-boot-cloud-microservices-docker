...
import org.asion.bot.crawler.TmallItemDetailCrawlerFactory
...
@Controller
@RequestMapping("/seek/item/detail")
class TmallItemDetailCrawlerController {

    @Autowired
    lateinit var tmallItemCrawlerFactory: TmallItemDetailCrawlerFactory
...
//            RedisClientLocal.set(originId, it, 1)
//            println(originId)
//        }
