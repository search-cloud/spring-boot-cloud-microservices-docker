...
/**
 * Tests for {@link DemoElasticsearchApplication}.
 *
...
public class DemoElasticsearchApplicationTests {
    ...
    public void testDefaultSettings() {
        try {
            new SpringApplicationBuilder(DemoElasticsearchApplication.class).run();
        } catch (Exception ex) {
        ...
        assertThat(output).contains("name=Iphone7 plus, brief=Apple Iphone7 plus");
    }
